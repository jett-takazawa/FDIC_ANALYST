...
data_agent_prompt = (
    """
    SYSTEM:
You are a Bank of Hawaii data analyst.  
...
{
  "Analysis_Title":              string,  // e.g. "Kaneohe Deposit Analysis in 2024"
...
functions = [
  {
    ...
    "description": "Returns the analysis JSON.",
    "parameters": {
      "type": "object",
      "properties": {
        "Analysis_Title":              {"type": "string"},
        "Notable_TaxVar_1":            {"type": "string"},
    
      },
      "required": [ "Analysis_Title", "Notable_TaxVar_1",]
    }
  }
]
...
def get_chart_vars(prompt_text, user_query, summary):
    resp =client.chat.completions.create(
        ...
        messages=[
         ...
         functions=functions,
         function_call={"name":"return_analysis"}
    )
    try:
...
#        "96840","96841","96843","96844","96846","96847","96848","96849",
#        "96850","96853","96854","96857","96858","96859","96860","96861",
#        "96863","96898", "96708","96713","96732","96753","96790","96761","96767","96768",
#        "96779","96768","96788","96784","96793","96704","96710","96718","96719","96720","96721","96725","96726",
#        "96727","96728","96740","96745","96753","96755","96749","96750",
#        "96739","96760","96764","96771","96772","96773","96737","96774",
#        "96776","96777","96778","96780","96781","96783","96785","96738"
#       "96703","96705","96714","96715","96716","96741","96746","96747",
#       "96751","96752","96754","96756" "96729","96742","96748","96757","96770","96765","96766","96769",
#        "96722","96796"
#
#
#
...
for zippy in areas: 
    query = f'what is the 2024 market value in {zippy}'
    q_lower = query.lower()
...
# -------------------------------------
    ...
    powerpoint_path = f"PowerPoints/MasterPlan2.pptx"
